                ...
                <strong>KissanSeva</strong> 
                    ...
                    <div className="collapse navbar-collapse " id="navbarNav" >
                        ...
                        <li className="nav-item ">
                                <a className="nav-link active" aria-current="page" href="/terms-condition"><strong>Terms & Condition</strong></a>
                            </li>
                            <li className="nav-item ">
                                <a className="nav-link active" aria-current="page" href="#"><strong>Home</strong></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="https://en.wikipedia.org/wiki/Farm"><strong>Info</strong></a>
                            </li>
                            { ! AuthenticateService.isUserLoggedIn() && <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li><Link className="dropdown-item" to="/farmer-reg"><strong>Farmer</strong></Link></li>
                                    <li><Link className="dropdown-item" to="/buyer-reg"><strong>Buyer</strong></Link></li>
                                </ul>
                            </li>}
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <li><Link className="dropdown-item" to="/farmer-login"><strong>Farmer Login</strong></Link></li>
                                    <li><Link className="dropdown-item" to="/buyer-login"><strong>Buyer Login</strong></Link></li>
                                    <li><Link className="dropdown-item" to="/admin-login"><strong>Admin Login</strong></Link></li>
                                </ul>
                            </li>}
